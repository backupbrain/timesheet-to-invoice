/*
  ...
  - You are about to drop the column `spendDate` on the `TaskTime` table. All the data in the column will be lost.
  - Added the required column `spentDate` to the `TaskTime` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_TaskTime" ("billable", "billableRate", "budgeted", "clientId", "costRate", "createdAt", "endedTime", "harvestId", "hours", "hoursWithoutTimer", "id", "isBilled", "isClosed", "isRunning", "lockedReason", "notes", "projectId", "roundedHours", "startedTime", "taskAssignmentId", "taskId", "timerStartedAt", "updatedAt", "userAssignmentId", "userId") SELECT "billable", "billableRate", "budgeted", "clientId", "costRate", "createdAt", "endedTime", "harvestId", "hours", "hoursWithoutTimer", "id", "isBilled", "isClosed", "isRunning", "lockedReason", "notes", "projectId", "roundedHours", "startedTime", "taskAssignmentId", "taskId", "timerStartedAt", "updatedAt", "userAssignmentId", "userId" FROM "TaskTime";
DROP TABLE "TaskTime";
